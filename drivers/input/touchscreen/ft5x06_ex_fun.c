...
//	#include "FT_Version0x11_test_app.i"
};
...
*/
static DEVICE_ATTR(ftstpfwver, 0664 /*S_IRUGO | S_IWUSR*/, ft5x0x_tpfwver_show,
		   ft5x0x_tpfwver_store);

/*upgrade from *.i
*example: echo 1 > ftsfwupdate
*/
static DEVICE_ATTR(ftsfwupdate, 0664/*S_IRUGO | S_IWUSR*/, ft5x0x_fwupdate_show,
...
*/
static DEVICE_ATTR(ftstprwreg, 0664/*S_IRUGO | S_IWUSR*/, ft5x0x_tprwreg_show,
...
*/
static DEVICE_ATTR(ftsfwupgradeapp, 0664/*S_IRUGO | S_IWUSR*/, ft5x0x_fwupgradeapp_show,
...
// ft5x0x attribute link
//check FW version -> cat  /sys/bus/i2c/drivers/ft5x0x_ts/1-0038/ftstpfwver
	int err;
