...
static struct tegra11_emc_table e1545_h5tc4g63afr_rda_T40S_table[] = {
	{
		0x41,       /* Rev 4.0.3 */
...
static struct tegra11_emc_pdata e1545_h5tc4g63afr_rda_T40S_pdata = {
	.description = "e1545_h5tc4g63afr_rda_T40S",
	.tables = e1545_h5tc4g63afr_rda_T40S_table,
	.num_tables = ARRAY_SIZE(e1545_h5tc4g63afr_rda_T40S_table),
};
...
static struct tegra11_emc_pdata *macallan_get_emc_data(void)
{
	...
	if (tegra_get_memory_type())
		return &e1545_h5tc4g63afr_rda_T40S_pdata;
	else
