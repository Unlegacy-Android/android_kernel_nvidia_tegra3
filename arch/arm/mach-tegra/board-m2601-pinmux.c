...
static __initdata struct tegra_pingroup_config m2601_pinmux_common[] = {
	...
	/* SDMMC3 pinmux */
	DEFAULT_PINMUX(SDMMC3_CLK,	SDMMC3,		PULL_UP,	NORMAL,		OUTPUT),
	...
	/* SPI2 pinmux */
	DEFAULT_PINMUX(ULPI_DATA4,	SPI2,		PULL_UP,	NORMAL,		OUTPUT),
	...
	DEFAULT_PINMUX(PEX_L0_RST_N,	PCIE,		NORMAL,		TRISTATE,	INPUT),
